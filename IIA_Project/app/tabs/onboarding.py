...
def render_unknown_plate(plate: str, profile: dict) -> None:
    ...
    with st.expander("This plate is not registered — onboard it live", expanded=True):
        ...
        group_label("Step 1 — register at the RTO (REG)")
        c1, c2 = st.columns(2)
        ...
        group_label("Step 2 — insure it (INS)")
        c3, c4 = st.columns(2)
        ...
        group_label("Step 4 — re-evaluate")
        if st.button("Re-evaluate this plate", key="ob_requery", type="primary"):
